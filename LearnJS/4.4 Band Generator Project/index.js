...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs",{random: "Welcome to Band Generator", year: year});
});
...
app.post("/submit", (req, res) => {
  ...
  let adjNo = Math.floor(Math.random() * adj.length);
  let nounNo = Math.floor(Math.random() * noun.length);
  res.render("index.ejs",{random: `${adj[adjNo]} ${noun[nounNo]}`, year: year});
});
